...
export function RainbowButton({onClick}){
    ...
    >
      <div className="relative flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-blue-300 via-blue-500 via-40% to-purple-500 px-4 py-2 text-white">
        ...
        <Sparkle
          ...
          className="absolute left-3 top-3 size-1.0 animate-sparkle fill-white"
        />

        <span className="font-semibold text-4xl">Get Access </span>
      </div>
      {!!particleState && (
        <Particles
          id="whatever"
